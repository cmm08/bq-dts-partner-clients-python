...
_TRANSFERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partner_connection_info', full_name='google.cloud.bigquery.datatransfer.v1.TransferConfig.partner_connection_info', index=14,
...
_TRANSFERRUN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partner_token', full_name='google.cloud.bigquery.datatransfer.v1.TransferRun.partner_token', index=14,
...
TransferConfig = _reflection.GeneratedProtocolMessageType('TransferConfig', (_message.Message,), dict(
  ...
  Attributes:
      name:
          ...
          names have the form of ``projects/{project_id}/location/{regio
          n}/transferConfigs/{config_id}``. The name is automatically
...
_TRANSFERTYPE._options = _descriptor._ParseOptions(descriptor_pb2.EnumOptions(), _b('\030\001'))
_TRANSFERRUN_LABELSENTRY.has_options = True
_TRANSFERRUN_LABELSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
