...
from google.cloud.bigquery.datatransfer_v1.proto import datasource_pb2 as google_dot_cloud_dot_bigquery_dot_datatransfer__v1_dot_proto_dot_datasource__pb2
